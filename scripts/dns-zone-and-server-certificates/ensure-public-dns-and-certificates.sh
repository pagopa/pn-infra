...
parse_params() {
  ...
  certificateSubdomainsAndRegion="api#${zoneRegion} webapi#${zoneRegion} portale-pa#${cloudFrontRegion} portale#${cloudFrontRegion} portale-login#${cloudFrontRegion} www#${cloudFrontRegion} api-io#${zoneRegion} api.radd#${zoneRegion} api-selcpg#${zoneRegion}"
